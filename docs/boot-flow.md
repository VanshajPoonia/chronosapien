...
6. Our kernel initializes a small COM1 serial logger, configures the VGA theme, logs the boot sequence, prints the structured Time Capsule OS startup banner, and then halts.
