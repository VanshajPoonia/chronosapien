//! Tiny 8x8 bitmap font for the framebuffer console.

pub const FONT_WIDTH: usize = 8;
pub const FONT_HEIGHT: usize = 8;

pub fn glyph(byte: u8) -> [u8; FONT_HEIGHT] {
    let byte = match byte {
        b'a'..=b'z' => byte - 32,
        _ => byte,
    };
    ...
    match byte {
        ...
        b'<' => [0x0c, 0x10, 0x20, 0x40, 0x20, 0x10, 0x0c, 0x00],
        b'=' => [0x00, 0x00, 0x7e, 0x00, 0x7e, 0x00, 0x00, 0x00],
        b'>' => [0x30, 0x08, 0x04, 0x02, 0x04, 0x08, 0x30, 0x00],
        b'?' => [0x3c, 0x42, 0x02, 0x0c, 0x10, 0x00, 0x10, 0x00],
        ...
        b'X' => [0x42, 0x24, 0x18, 0x18, 0x18, 0x24, 0x42, 0x00],
        ...
        b'\\' => [0x40, 0x20, 0x10, 0x08, 0x04, 0x02, 0x00, 0x00],
        ...
        b'`' => [0x20, 0x10, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00],
        b'{' => [0x0c, 0x10, 0x10, 0x60, 0x10, 0x10, 0x0c, 0x00],
        b'|' => [0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x00],
        b'}' => [0x30, 0x08, 0x08, 0x06, 0x08, 0x08, 0x30, 0x00],
        b'~' => [0x00, 0x00, 0x32, 0x4c, 0x00, 0x00, 0x00, 0x00],
        _ => [0x7e, 0x42, 0x5a, 0x52, 0x5a, 0x42, 0x7e, 0x00],
    }
}
